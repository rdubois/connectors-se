...
@PartitionMapper(name = "SQLAPICollectionInput")
@Documentation("cosmosDB input Mapper")
public class CosmosDBCollectionInputMapper implements Serializable {
    ...
    public CosmosDBCollectionInputMapper(@Option("configuration") final CosmosDBCollectionInputConfiguration configuration,
            final CosmosDBService service, final RecordBuilderFactory recordBuilderFactory, final I18nMessage i18nMessage) {
    ...
    @Split
    public List<CosmosDBCollectionInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 CosmosDBInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public CosmosDBCollectionInput createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new CosmosDBCollectionInput(configuration, service, recordBuilderFactory, i18nMessage);
    }
}